...
public class MdUtils {
    ...
    private static Document render(String text, boolean debug) {
        ...
        final TextDecoration headingOneTextDecoration = TextDecoration.builder().presets().fontFamily("Arial").fontWeight(BOLD).fontSize(18).build();
        ...
        final TextDecoration headingTwoTextDecoration = TextDecoration.builder().presets().fontFamily("Arial").fontWeight(BOLD).fontSize(16).build();
        ...
        final TextDecoration headingThreeTextDecoration = TextDecoration.builder().presets().fontFamily("Arial").fontWeight(BOLD).fontSize(14).build();
        ...
        final TextDecoration presetTextDecoration = TextDecoration.builder().presets().fontFamily("Arial").build();
        final TextDecoration monospaceDecoration = TextDecoration.builder().presets().fontFamily("Monospace").background(Color.GAINSBORO).foreground(Color.BLACK).build();
