...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --main-jar %MAIN_JAR% ^
  --java-options "-Xmx2048m --enable-preview -add-modules jdk.incubator.vector --add-opens java.base/jdk.internal.misc=ALL-UNNAMED --enable-native-access=ALL-UNNAMED" ^
